...
import { LayoutDashboard, FileText, CalendarDays, RotateCw, Newspaper, Sun, Moon, ArrowLeftRight, User, LogOut, BarChart3, Trophy, NotebookPen, Library } from 'lucide-react'
